...
namespace Lizard.Logic.NN
{
    ...
    public unsafe struct NetContainer<T, U>
    {
        ...
        public NetContainer()
        {
            ...
            L1Weights = (T*)AlignedAllocZeroed((nuint)sizeof(T) * (L1_SIZE * L2_SIZE * 2));
            L1Biases  = (U*)AlignedAllocZeroed((nuint)sizeof(U) * (L2_SIZE));
            L2Weights = (U*)AlignedAllocZeroed((nuint)sizeof(U) * (L2_SIZE * L3_SIZE));
            L2Biases  = (U*)AlignedAllocZeroed((nuint)sizeof(U) * (L3_SIZE));
            L3Weights = (U*)AlignedAllocZeroed((nuint)sizeof(U) * (L3_SIZE));
